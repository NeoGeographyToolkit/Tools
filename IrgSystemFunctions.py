...
def isCmdOption(arg):
    """Returns True if the string is a command line option, False otherwise (if it is an argument)"""
...
#TODO: Make sure this works for commands with wildcards
def executeCommand(cmd, suppressOutput=False, echoCmd=False):
    """Executes a command line"""
    
    if echoCmd:
        print cmd
    
    # The inputs need to be in list format
